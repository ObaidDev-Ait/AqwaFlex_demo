          ...
          <div className="md:col-span-5 flex flex-col gap-gutter gap-y-6">
            <Link href="/products" className="min-h-[180px] md:flex-1 relative group overflow-hidden rounded-[24px] cursor-pointer block">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDnebScj-mTUFFg5Vi-7CSteDovfedMP2BhUY_6ZLJJAtdCCOmaLGa8c1opXEjuzuSFflNrV9V2qvoKMU5jEraecvAxsWQW6CNa7kux1DXlrqrFxz5MRWMWhQhp8QZNKXuC20qYjpGYEK6OHwZX_43zOXCxxed5NeL1Ogk8JfQHZd3lYhZsfxeBhBVZ8BQ07cAW0NFhcXbUCkFGhJBpMuVnBo3dT1tr98-2EWwRKC_IWMFLaDv0UAO9ypLJJLw1fUD7XPf7oVkZFt97')",
                }}
              ></div>
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/10 transition-colors"></div>
