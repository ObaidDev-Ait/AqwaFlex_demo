...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="md:hidden fixed bottom-24 right-6 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-[0_8px_24px_rgba(37,211,102,0.3)] active:scale-95 transition-all duration-300 group"
    >
      {/* Pulse Rings */}
